...
upper_bound = 1.8315640000e5 # group 9
lower_bound = 1.1109000000e5 # group 10
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g10_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g10_Pu9_{coeff:0.3f}_MT18.pendf"
