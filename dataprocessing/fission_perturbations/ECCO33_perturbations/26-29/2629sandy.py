...
lower_bound = 8.3152870000e0  # group 29 eV
upper_bound = 4.0169000000e1   # group 26 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g26-29_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g26-29_Pu9_{coeff:0.3f}_MT18.pendf"
