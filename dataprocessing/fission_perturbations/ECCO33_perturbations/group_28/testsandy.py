...
perturbation_coefficients = [-0.500, 0.0, 0.500]
...
lower_bound = 1.3709590000e1  # group 28 eV
upper_bound = 2.2603290000e1   # group 27 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g28_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g28_Pu9_{coeff:0.3f}_MT18.pendf"
