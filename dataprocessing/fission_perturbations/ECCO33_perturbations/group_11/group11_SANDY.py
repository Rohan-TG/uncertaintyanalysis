...
lower_bound = 6.7379470000e4  # group 11 eV
upper_bound = 1.1109000000e5   # group 10 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g11_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g11_Pu9_{coeff:0.3f}_MT18.pendf"
