...
lower_bound = 2.0346840000e3  # group 18 eV
upper_bound = 3.3546260000e3   # group 17 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g18_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g18_Pu9_{coeff:0.3f}_MT18.pendf"
