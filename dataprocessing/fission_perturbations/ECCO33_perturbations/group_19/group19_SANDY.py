...
lower_bound = 1.2340980000e3  # group 19 eV
upper_bound = 2.0346840000e3   # group 18 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g19_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g19_Pu9_{coeff:0.3f}_MT18.pendf"
