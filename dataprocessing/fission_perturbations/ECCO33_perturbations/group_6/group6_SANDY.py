...
lower_bound = 8.2085000000e5  # group 6 eV
upper_bound = 1.3533530000e6   # group 5 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g6_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g6_Pu9_{coeff:0.3f}_MT18.pendf"
