...
lower_bound = 2.4787520000e4  # group 13 eV
upper_bound = 4.0867710000e4   # group 12 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g13_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g13_Pu9_{coeff:0.3f}_MT18.pendf"
