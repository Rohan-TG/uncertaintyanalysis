...
lower_bound = 3.0197380000e5  # group 8 eV
upper_bound = 4.9787070000e5   # group 7 eV
...
for coeff in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
    ...
    savefilename = f"ECCO33-g8_Pu9_{coeff:0.3f}_MT18.09c"
    with open(f"{savefilename}", mode="w") as f:
        f.write(outs["ace"])

    savefilependf = f"ECCO33-g8_Pu9_{coeff:0.3f}_MT18.pendf"
