...
perturbation_domain = np.arange(-0.4, 0.4, 0.02)
...
first_group_lower_bound = Groups.g2
first_group_upper_bound = Groups.g1
first_group_domain = [first_group_lower_bound, first_group_upper_bound]

secondary_lower_bound = Groups.g3
secondary_upper_bound = Groups.g2
...
def run_sandy(pair):
	...
	secondary_heated_pendf_pert.to_file(f'Pu239-dual_g{first_group}_{pg1:0.3f}_g{second_group}_{pg2:0.3f}_MT18.pendf')
	...
	savefilename2 = f"Pu239-dual_g{first_group}_{pg1:0.3f}_g{second_group}_{pg2:0.3f}_MT18.09c"
