...
endf6 = sandy.Endf6.from_file('/home/rnt26/PycharmProjects/uncertaintyanalysis/n-094_Pu_240.endf')         # sandy.get_endf6_file("ENDFB_80", "xs", za * 10)
...
lower_bound = Groups.g2  # group 2 eV
upper_bound = Groups.g1  # group 1 eV
