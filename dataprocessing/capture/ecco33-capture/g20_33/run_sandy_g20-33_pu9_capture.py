...
endf6 = sandy.Endf6.from_file('/home/rnt26/uncertaintyanalysis/n-094_Pu_239.endf')    # sandy.get_endf6_file("ENDFB_80", "xs", za * 10)
...
lower_bound = Groups.g33  # group 33 eV
upper_bound = Groups.g20   # group 20 eV
