...
pertgroup = '/home/rnt26/PycharmProjects/uncertaintyanalysis/dataprocessing/fission_perturbations/ECCO33_perturbations/ECCO33-14_Pu-239_coeff_0.300_MT18.pendf'
...
fpert = open(pertgroup)
linesp = fpert.readlines()
secp = ENDF6.find_section(linesp, MF=3, MT=18)
xp, yp = ENDF6.read_table(secp)
...
plt.plot(xp, yp, label = 'group perturbation')
...
plt.legend()
plt.savefig('Group_pert_test.png', dpi = 200)
plt.show()