...
from groupEnergies import Groups, Ga71, Reactions
...
def run_sandy(coeff):
	...
	savefilename = f"Ga-71_g{group}_{coeff:0.3f}_MT{mt}.09c"
	with open(f"{savefilename}", mode="w") as f:
		f.write(outs["ace"])

	savefilependf = f"Ga-71_g{group}_{coeff:0.3f}_MT{mt}.pendf"
