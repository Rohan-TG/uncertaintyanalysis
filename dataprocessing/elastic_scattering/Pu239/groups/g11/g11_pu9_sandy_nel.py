...
endf6 = sandy.Endf6.from_file('/home/rnt26/PycharmProjects/uncertaintyanalysis/n-094_Pu_239.endf')                         # sandy.get_endf6_file("ENDFB_80", "xs", za * 10)
...
lower_bound = Groups.g11  # group 11 eV
upper_bound = Groups.g10  # group 10 eV
...
def run_sandy(coeff):
	...
	savefilependf = f"Pu9_g{group}_{coeff:0.3f}_MT{mt}.pendf"
