...
lower_bound = Groups.g6  # group 6 eV
upper_bound = Groups.g5   # group 5 eV
...
def run_sandy(coeff):
	...
	savefilename = f"Pu239_g{group}_{coeff:0.3f}_MT2.09c"
	with open(f"{savefilename}", mode="w") as f:
		f.write(outs["ace"])

	savefilependf = f"Pu9_g{group}_{coeff:0.3f}_MT2.pendf"
