...
ACE_file_directory = '/home/rnt26/PycharmProjects/uncertaintyanalysis/data/ecco19Pu9/' # location of the ECCO Group 19 perturbed ACE files to be used for generating samples
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	libfile = 'lib19.xsfile'

	input_coefficient = round(coefficient, 3) # Coefficient string prep

	ACE_filename = f"{ACE_file_directory}/ECCO33-g19_Pu9_{input_coefficient:0.3f}_MT18.09c" # name of ACE file for this SCONE run
