...
ACE_file_directory = '/home/rnt26/uncertaintyanalysis/data/g2326/mt18' # location of the ECCO Group 6 perturbed ACE files to be used for generating samples
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/ECCO33-g23-26_Pu9_{input_coefficient:0.3f}_MT18.09c" # name of ACE file for this SCONE run
