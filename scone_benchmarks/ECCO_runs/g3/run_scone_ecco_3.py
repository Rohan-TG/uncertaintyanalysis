...
ACE_file_directory = '/home/rnt26/PycharmProjects/uncertaintyanalysis/data/ecco3Pu9/' # location of the ECCO Group 6 perturbed ACE files to be used for generating samples
...
perturbation_coefficients = np.arange(0.282, 0.501, 0.001)
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/ECCO33-g3_Pu9_{input_coefficient:0.3f}_MT18.09c" # name of ACE file for this SCONE run
