...
ACE_file_directory = '/home/rnt26/PycharmProjects/uncertaintyanalysis/data/ecco10Pu9/' # location of the ECCO Group 10 perturbed ACE files to be used for generating samples

scone_executable_path = '/home/rnt26/scone/SCONE/Build/scone.out' # location of the scone executable

num_cores = 25 # number of cores to use for this specific instance of scone
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	libfile = 'lib10.xsfile'

	input_coefficient = round(coefficient, 3) # Coefficient string prep

	ACE_filename = f"{ACE_file_directory}/ECCO33-g10_Pu9_{input_coefficient:0.3f}_MT18.09c" # name of ACE file for this SCONE run
