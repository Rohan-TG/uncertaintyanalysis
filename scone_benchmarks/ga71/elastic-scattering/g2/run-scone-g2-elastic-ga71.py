...
from groupEnergies import Ga71, Reactions
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/Ga-71_g{group}_{input_coefficient:0.3f}_MT{MT}.09c" # name of ACE file for this SCONE run
