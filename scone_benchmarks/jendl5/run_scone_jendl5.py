...
for pu239_ace_file, pu240_ace_file, pu241_ace_file in tqdm.tqdm(zip(Pu239_ACE_files, Pu240_ACE_files, Pu241_ACE_files), total=len(Pu239_ACE_files)):
	...
	subprocess.run(f'mv output.m outputfiles/output-JENDL5-Pu239_{pu239_file_index}_Pu240_{pu240_file_index}_Pu241_{pu241_file_index}.m',
...
index_dataframe.to_csv('Plutonium_only_JENDL5_scone_run_indices.csv')
