...
ACE_file_directory = f'/home/rnt26/PycharmProjects/uncertaintyanalysis/data/Pu241/elastic_scattering/g{group}'
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/Pu241_g{group}_{input_coefficient:0.3f}_MT{MT}.09c" # name of ACE file for this SCONE run
