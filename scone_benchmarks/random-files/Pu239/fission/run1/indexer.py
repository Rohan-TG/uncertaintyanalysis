...
# pendf_dir = '/home/rnt26/uncertaintyanalysis/dataprocessing/random-files/Pu239/fission/run3/pendf'
...
for old_i, new_i in tqdm.tqdm(zip(original_indices, new_indices), total=len(original_indices)):
	...
	# subprocess.run(f'mv {pendf_dir}/{old_pendf_filename} {pendf_dir}/{new_ace_filename}', shell=True)
