...
ACE_file_directory = f'/home/rnt26/PycharmProjects/uncertaintyanalysis/data/Pu240/n2n/g{group}'
...
perturbation_coefficients = np.arange(-0.800, 0.801, 0.002)
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/Pu240_g{group}_{input_coefficient:0.3f}_MT16.09c" # name of ACE file for this SCONE run
