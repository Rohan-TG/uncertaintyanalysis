...
ACE_file_directory = '/home/rnt26/uncertaintyanalysis/data/n2n/pu9/g1'
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/Pu239_g1_{input_coefficient:0.3f}_MT16.09c" # name of ACE file for this SCONE run
