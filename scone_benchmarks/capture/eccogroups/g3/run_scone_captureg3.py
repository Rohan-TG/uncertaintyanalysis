...
ACE_file_directory = '/home/rnt26/uncertaintyanalysis/data/ng/g3' # location of the ECCO Group 3 capture perturbed ACE files
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	libfile = 'lib3ng.xsfile'

	input_coefficient = round(coefficient, 3) # Coefficient string prep

	ACE_filename = f"{ACE_file_directory}/ECCO33-g3_Pu9_{input_coefficient:0.3f}_MT102.09c" # name of ACE file for this SCONE run
