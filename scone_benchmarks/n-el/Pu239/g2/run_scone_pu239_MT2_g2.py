...
ACE_file_directory = '/home/rnt26/PycharmProjects/uncertaintyanalysis/data/nelastic/Pu239/g2'
...
for coefficient in tqdm.tqdm(perturbation_coefficients, total=len(perturbation_coefficients)):
	...
	ACE_filename = f"{ACE_file_directory}/Pu239_g2_{input_coefficient:0.3f}_MT2.09c" # name of ACE file for this SCONE run
