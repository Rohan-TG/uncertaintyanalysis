...
ACE_file_directory = f'/home/rnt26/PycharmProjects/uncertaintyanalysis/data/multi/pu9/fission_elastic/g3_g6'
...
for ACE in tqdm.tqdm(ACE_names, total=len(ACE_names)):
	...
	ACE_filename = f"{ACE_file_directory}/Pu-239_g{group1}_MT{First_MT}_{coefficient1:0.3f}_{group2}_MT{Second_MT}_{coefficient2:0.3f}.09c" # name of ACE file for this SCONE run
	...
	subprocess.run(f'mv output.m outputfiles/output_MT{First_MT}_{float(coefficient1):0.3f}_MT{Second_MT}_{float(coefficient2):0.3f}.m', shell=True) # move output file to output directory for later analysis
