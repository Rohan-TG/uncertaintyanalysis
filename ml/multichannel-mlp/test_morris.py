...
all_fission_parquets = os.listdir(training_fission_data_directory)
all_elastic_parquets = os.listdir(training_elastic_data_directory)
...
training_files = all_fission_parquets + all_elastic_parquets
