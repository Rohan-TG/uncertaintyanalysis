...
g5boundary = Groups.g5
g4boundary = Groups.g4

all_parquets = []

data_directory = f'/home/rnt26/PycharmProjects/uncertaintyanalysis/ml/mldata/Pu239/fission/g5/xserg_data/'
...
for file in tqdm.tqdm(training_files, total=len(training_files)):
	...
	dftrain = dftrain[dftrain.ERG >= g5boundary]
...
for file in tqdm.tqdm(test_files, total=len(test_files)):
	...
	dftest = dftest[dftest.ERG >= g5boundary]
