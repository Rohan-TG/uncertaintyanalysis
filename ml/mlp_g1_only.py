...
g1boundary = Groups.g1
g0boundary = Groups.g0

all_parquets = []

data_directory = f'/home/rnt26/PycharmProjects/uncertaintyanalysis/ml/mldata/Pu239/fission/g1/xserg_data/'
...
for file in tqdm.tqdm(training_files, total=len(training_files)):
	...
	dftrain = dftrain[dftrain.ERG >= g1boundary]
...
for file in tqdm.tqdm(test_files, total=len(test_files)):
	...
	dftest = dftest[dftest.ERG >= g1boundary]
